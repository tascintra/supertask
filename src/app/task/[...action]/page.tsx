...
export default function Page({ params }: PageProps) {
  ...
  return (
    <main className="mx-auto flex h-full w-full max-w-2xl flex-col gap-5 divide-y divide-neutral-200 rounded-3xl border-neutral-200 py-8 dark:divide-dark-300 dark:border-dark-400 dark:shadow-neutral-900 sm:my-20 sm:border sm:shadow-md dark:sm:shadow-component md:h-fit">
      ...
      <section className="h-full px-5">
        ...
        >
          ...
          <Button
            type="submit"
            color="confirm"
            className="mx-auto mb-2 mt-8 max-w-[224px] md:mt-7"
          >
